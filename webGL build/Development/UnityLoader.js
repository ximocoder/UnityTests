...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3570672;
      var PACKAGE_UUID = '44f73db5-2839-45d2-b2bd-0c04df8aa501';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20260, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20260, 31180, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31180, 169856, 0, 0).open('GET', '/level0');
    new DataRequest(169856, 169877, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(169877, 172755, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(172755, 183399, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(183399, 1984947, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1984947, 3482319, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3482319, 3543047, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(3543047, 3570672, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
